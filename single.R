###############################################################################
## Hierarchisches Clustern mit Single-Linkage #################################
###############################################################################
...
hc <- hclust(d, method="single")      # Clusterberechnung
...
writeOGR(obj=spdf, dsn="shapefiles", layer="single", driver="ESRI Shapefile") # Shapefile schreiben
