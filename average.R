###############################################################################
## Hierarchisches Clustern mit Average-Linkage ################################
###############################################################################
...
hc <- hclust(d, method="average")      # Clusterberechnung
...
writeOGR(obj=spdf, dsn="shapefiles", layer="average", driver="ESRI Shapefile") # Shapefile schreiben
